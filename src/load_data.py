...
def load_data():
    # Read the CSV file
    df = pd.read_csv('/mnt/c/Users/sarah/OneDrive/Desktop/School/2024/Fall/SWDevCS-3250-002/CS3250/Prog3/project-3-final-project-thedreamteam2/Database/mysticburgers.csv')
